...
| `codex-rs/tui/src/history_cell.rs` | 历史项渲染入口。 |
...
| `HistoryCell` | `codex-rs/tui/src/history_cell.rs` 及相邻模块 | 把 agent message、reasoning、tool call、diff、approval、error 渲染成终端 cell。 |
